...
function Navbar() {
  // Define the handleClick function for toggling the menu
  function handleClick() {
    console.log("Menu toggled!");
    // Logic for toggling menu can be added here
  }
    ...
    <div>
      <nav>
        ...
        <ul className="nav__links active">
          ...
          <li className="link">
            <button className="link-button" onClick={() => console.log("Appointments clicked!")}>
              Appointments
            </button>
          </li>
